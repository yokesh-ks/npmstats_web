	...
	return (
		<>
			<CatalogJsonLd
				...
				description="Explore the most popular NPM packages analyzed on NpmStats. Get comprehensive insights and make informed decisions about your dependencies."
				url={`${siteConfig.url}/package`}
			/>
